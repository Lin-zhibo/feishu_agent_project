...
async def run_solution(inp: StageInput) -> StageOutput:
...
async def run_code_gen(inp: StageInput) -> StageOutput:
...
async def run_test_gen(inp: StageInput) -> StageOutput:
...
async def run_review(inp: StageInput) -> StageOutput:
...
async def run_delivery(inp: StageInput) -> StageOutput:
